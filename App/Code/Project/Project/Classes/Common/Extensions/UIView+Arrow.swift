...
public extension UIView {
    ...
    func applyArrowDialogAppearanceWithOrientation(arrowOrientation: UIImageOrientation, arrowLength: CGFloat = 20.0) {
        let shapeLayer = CAShapeLayer()
        shapeLayer.path = dialogBezierPathWithFrame(self.frame, arrowOrientation: arrowOrientation, arrowLength: arrowLength).cgPath
        shapeLayer.fillColor = UIColor.red.cgColor // self.backgroundColor?.cgColor ?? UIColor.white.cgColor
